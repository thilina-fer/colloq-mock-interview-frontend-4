...
import { useNavigate } from "react-router-dom"; // 1. useNavigate අනිවාර්යයෙන් import කරන්න ඕනේ
...
const Login = () => {
  ...
  const navigate = useNavigate(); // 2. navigate variable එක මෙතන define කරන්න ඕනේ
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#FDFDFD]">
      ...
      >
        <div
          className="absolute top-[-10%] left-[-10%] w-64 h-64 rounded-full opacity-10 transition-all duration-700 hover:scale-150 hover:opacity-20"
        ...
        <div className="max-w-md z-10 text-center lg:text-left group">
          ...
          <div className="cursor-default">
            <h1
              className="text-6xl font-extrabold tracking-tight mb-6 transition-all duration-500 ease-out group-hover:translate-x-4 group-hover:text-shadow-lg"
            ...
            <p
              className="text-lg leading-relaxed opacity-80 transition-all duration-500 group-hover:opacity-100 group-hover:translate-x-2"
              style={{ color: colors.textPrimary }}
            >
              Your next career move is just a login away. Pick up right where
              you left off.
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-[420px]">
          ...
          <div className="flex items-center my-8">
            ...
            <span className="px-4 text-xs font-bold tracking-widest opacity-30">
              OR
            </span>
          ...
          <form className="space-y-6">
            <div>
              <label
                className="text-sm font-bold ml-1 mb-2 block"
                style={{ color: colors.black }}
              >
                Username
              </label>
          ...
          >
            ...
            <button
              onClick={() => navigate("/register")} // මෙතන දැන් වැඩ කරයි
