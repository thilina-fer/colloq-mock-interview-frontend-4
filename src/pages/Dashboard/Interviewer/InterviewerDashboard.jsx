          ...
          >
            ...
            <div className="flex justify-between items-center">
              ...
              >
                ...
                >
                  <EngineeringIcon sx={{ fontSize: 16, mr: 1 }} /> Interviewer
                </button>
                <button
                ...
                >
                  <PersonSearchIcon sx={{ fontSize: 16, mr: 1 }} /> Candidate
                </button>
              </div>
            </div>
            ...
            {mode === "interviewer" ? (
              ...
              <div className="space-y-6 animate-in fade-in duration-500">
                {/* Yellow Highlight Box (Dark Theme Optimized) */}
                <div
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      ...
                      experts to get real-time feedback and sharpen your
                      interview performance.
                    </p>
                  </div>
                </div>

                {/* Main Action Button - Dark/Boxy Style */}
                <button
          ...
          <div className="flex-grow flex flex-col">
            ...
            >
              <button
                ...
                className={`pb-4 px-2 font-black text-[10px] uppercase tracking-[0.2em] transition-all relative ${activeTab === "pending" ? "text-orange-500" : "text-gray-500 hover:text-gray-300"}`}
              >
                {mode === "interviewer"
                  ? "Upcoming Interviews"
                  : "Pending Sessions"}
              ...
              <button
                ...
                className={`pb-4 px-2 font-black text-[10px] uppercase tracking-[0.2em] transition-all relative ${activeTab === "completed" ? "text-orange-500" : "text-gray-500 hover:text-gray-300"}`}
              >
                Completed Sessions
                {activeTab === "completed" && (
                  <div className="absolute bottom-0 left-0 w-full h-[2px] bg-orange-500"></div>
